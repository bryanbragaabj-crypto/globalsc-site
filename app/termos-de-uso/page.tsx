        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              ...
              <p>
                O presente instrumento estabelece os Termos e Condições Gerais de Uso da plataforma GLOBAL SC ATACADO (doravante denominada simplesmente "PLATAFORMA" ou "GLOBAL SC"), aplicáveis a todos os usuários que acessarem seus conteúdos, catálogos, fornecedores e informações comerciais. A utilização da plataforma implica na leitura, compreensão e aceitação integral das disposições abaixo.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 1 – DA NATUREZA DA PLATAFORMA
              </h3>
              <p>
                <strong>1.1.</strong> A GLOBAL SC ATACADO consiste em uma plataforma digital B2B destinada à divulgação de fornecedores, fabricantes, distribuidores, importadoras e produtos voltados ao mercado atacadista.<br/>
                <strong>1.2.</strong> A plataforma possui caráter estritamente informativo e comercial, funcionando como catálogo digital para consulta de produtos, fornecedores e oportunidades comerciais.<br/>
                <strong>1.3.</strong> A GLOBAL SC atua como um intermediador, não vende produtos de forma direta, não processa pagamentos, não emite notas fiscais de venda e não mantém estoque próprio.<br/>
                <strong>1.4.</strong> Toda negociação comercial ocorre diretamente entre o comprador e o fornecedor responsável pelo produto anunciado.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 2 – DO CADASTRO E ACESSO
              </h3>
              <p>
                <strong>2.1.</strong> O acesso a determinadas áreas da plataforma poderá exigir cadastro prévio.<br/>
                <strong>2.2.</strong> O usuário declara que todas as informações fornecidas são verdadeiras, completas e atualizadas.<br/>
                <strong>2.3.</strong> A GLOBAL SC poderá solicitar documentos para validação cadastral sempre que considerar necessário.<br/>
                <strong>2.4.</strong> O usuário é responsável pela guarda de seus dados de acesso e senha.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 3 – DOS PRODUTOS E FORNECEDORES
              </h3>
              <p>
                <strong>3.1.</strong> Os produtos, imagens, descrições, preços, estoques, prazos de entrega e demais informações exibidas na plataforma são fornecidos pelos respectivos fornecedores.<br/>
                <strong>3.2.</strong> A GLOBAL SC não garante a disponibilidade contínua de produtos anunciados.<br/>
                <strong>3.3.</strong> Alterações de preços, estoques, condições comerciais e disponibilidade poderão ocorrer sem aviso prévio, sendo de responsabilidade exclusiva do fornecedor.<br/>
                <strong>3.4.</strong> A responsabilidade pela qualidade, fabricação, garantia, regularidade fiscal e entrega dos produtos pertence exclusivamente ao fornecedor responsável pela emissão da respectiva Nota Fiscal.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 4 – DAS NEGOCIAÇÕES COMERCIAIS
              </h3>
              <p>
                <strong>4.1.</strong> A plataforma atua apenas como facilitadora de conexões entre compradores e fornecedores.<br/>
                <strong>4.2.</strong> A GLOBAL SC não recebe pagamentos via PIX, cartões de crédito, cartões de débito, boletos bancários, transferência bancária ou qualquer outro meio de pagamento.<br/>
                <strong>4.3.</strong> Condições comerciais, descontos, faturamentos, formas de pagamento, fretes e demais condições de negociação deverão ser tratadas diretamente com o fornecedor responsável.<br/>
                <strong>4.4.</strong> A plataforma não atua como instituição financeira, correspondente bancário ou intermediadora de pagamentos.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 5 – DAS TROCAS, DEVOLUÇÕES E GARANTIAS
              </h3>
              <p>
                <strong>5.1.</strong> As políticas de troca, devolução, garantia e logística reversa serão regidas pelos documentos específicos disponibilizados na plataforma ou pelos fornecedores responsáveis.<br/>
                <strong>5.2.</strong> A GLOBAL SC não executa processos de troca, coleta, logística reversa ou reembolso.<br/>
                <strong>5.3.</strong> Produtos com defeito de fabricação ou vícios ocultos são de responsabilidade exclusiva da marca/fabricante.
              </p>
              ...
              <p>
                <strong>6.1.</strong> A GLOBAL SC atua exclusivamente como vitrine digital de divulgação (intermediação Asset-Light).<br/>
                <strong>6.2.</strong> A plataforma não se responsabiliza por:<br/>
                • Negociações realizadas entre usuários e fornecedores;<br/>
                • Pagamentos efetuados diretamente a empresas fornecedoras;<br/>
                • Entregas, atrasos ou extravios;<br/>
                • Divergências de estoque;<br/>
                • Defeitos de fabricação;<br/>
                • Garantia dos produtos;<br/>
                • Informações fornecidas pelos anunciantes;<br/>
                • Lucros cessantes, perdas comerciais ou prejuízos decorrentes de relações estabelecidas entre compradores e fornecedores.<br/>
                <strong>6.3.</strong> A responsabilidade cível, criminal, serviços, notas fiscais, tributos e cumprimento das obrigações comerciais pertence exclusivamente ao fornecedor responsável.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 7 – TRATAMENTO DE DADOS
              </h3>
              <p>
                A plataforma poderá registrar dados básicos de navegação, incluindo endereços IP, data, horário de acesso, navegador utilizado e demais informações necessárias para segurança, auditoria e cumprimento da legislação aplicável. O tratamento de dados observará as disposições da Política de Privacidade e da Lei Geral de Proteção de Dados (LGPD).
              </p>
              ...
              <p>
                <strong>8.1.</strong> Todo o conteúdo da plataforma, incluindo textos, logotipos, marcas, imagens, layouts e elementos gráficos, é protegido pela legislação de propriedade intelectual.<br/>
                <strong>8.2.</strong> É proibida a reprodução, distribuição ou utilização sem autorização prévia e expressa dos respectivos titulares.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 9 – ALTERAÇÕES DOS TERMOS
              </h3>
              <p>
                <strong>9.1.</strong> A GLOBAL SC poderá modificar estes Termos de Uso a qualquer momento, visando adequação legal, operacional ou comercial.<br/>
                <strong>9.2.</strong> As versões atualizadas entrarão em vigor a partir de sua publicação na plataforma.
              </p>
              ...
              <p>
                Fica eleito o Foro da Comarca de Florianópolis, Estado de Santa Catarina, para dirimir quaisquer controvérsias decorrentes destes Termos de Uso, renunciando as partes a qualquer outro, por mais privilegiado que seja.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 11 – ACEITAÇÃO
              </h3>
              <p>
                <strong>11.1.</strong> Ao acessar ou utilizar a plataforma, o usuário declara ter lido, compreendido e aceitado integralmente os presentes Termos e Condições Gerais de Uso.<br/>
                <strong>11.2.</strong> Caso não concorde com qualquer disposição deste documento, o usuário deverá interromper imediatamente a navegação e a utilização da plataforma.
              </p>
            </div>
