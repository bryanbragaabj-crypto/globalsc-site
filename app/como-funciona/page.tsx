        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              💼 COMO FUNCIONA O NOSSO ECOSSISTEMA B2B
            </h2>

            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              
              <p>
                A <strong>GLOBAL SC ATACADO</strong> opera como um ecossistema digital B2B inovador, focado em otimizar e aproximar a conexão comercial entre grandes fornecedores, indústrias, importadoras e lojistas em todo o território nacional.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                1. Homologação e Análise do Fornecedor
              </h3>
              <p>
                A empresa fornecedora passa por uma análise inicial detalhada e, após aprovação cadastral e jurídica, integra o ecossistema da Global SC, tornando-se parte ativa do nosso shopping de alto atacado digital. Isso garante que os lojistas compradores tenham acesso apenas a parceiros comerciais com capacidade comprovada de entrega, idoneidade e produtos de alta qualidade.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                2. Vitrine Tecnológica e Catálogo Inteligente
              </h3>
              <p>
                Organizamos a apresentação estruturada dos produtos dentro da plataforma, garantindo que os catálogos digitais sejam exibidos de forma clara, altamente profissional e estratégica. Essa vitrine tecnológica facilita o acesso dos atacadistas e lojistas às informações técnicas, tabelas de preços e oportunidades reais de compra a qualquer hora do dia.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                3. Negociação Direta e Transparência (Asset-Light)
              </h3>
              <p>
                Baseada no modelo <i>Asset-Light</i>, a plataforma funciona como um canal inteligente de intermediação. A Global SC não interfere nos preços, não retém margens ocultas e não processa pagamentos. O lojista visualiza o produto na nossa vitrine e inicia o contato para fechar o pedido diretamente com a indústria ou através da nossa mesa de suporte comercial oficial, garantindo o melhor preço direto da fábrica, sem intermediários financeiros.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                4. Fortalecimento de Marca e Expansão
              </h3>
              <p>
                Com o tempo, as marcas parceiras expandem sua presença geográfica de forma escalável dentro do ecossistema, consolidando sua participação no mercado físico e digital, enquanto os lojistas encontram um ambiente blindado, rastreável e pautado nas melhores práticas de conformidade corporativa.
              </p>
...
// ============================================================================
// COMPONENTES DE RODAPÉ E SELOS (Padronização Oficial)
// ============================================================================
