    ...
    <main className="min-h-screen w-full bg-[#eeeeee] text-black font-sans antialiased overflow-x-hidden flex justify-center">
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          <img 
            src="/banner-como-funciona.png" 
            alt="Como Funciona - Global SC" 
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              ðŸ’¼ COMO FUNCIONA O NOSSO ECOSSISTEMA B2B
            </h2>

            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              
              <p>
                A <strong>GLOBAL SC ATACADO</strong> opera como um ecossistema digital B2B inovador, focado em otimizar e aproximar a conexÃ£o comercial entre grandes fornecedores, indÃºstrias, importadoras e lojistas em todo o territÃ³rio nacional.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                1. HomologaÃ§Ã£o e AnÃ¡lise do Fornecedor
              </h3>
              <p>
                A empresa fornecedora passa por uma anÃ¡lise inicial detalhada e, apÃ³s aprovaÃ§Ã£o cadastral e jurÃ­dica, integra o ecossistema da Global SC, tornando-se parte ativa do nosso shopping de alto atacado digital. Isso garante que os lojistas compradores tenham acesso apenas a parceiros comerciais com capacidade comprovada de entrega, idoneidade e produtos de alta qualidade.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                2. Vitrine TecnolÃ³gica e CatÃ¡logo Inteligente
              </h3>
              <p>
                Organizamos a apresentaÃ§Ã£o estruturada dos produtos dentro da plataforma, garantindo que os catÃ¡logos digitais sejam exibidos de forma clara, altamente profissional e estratÃ©gica. Essa vitrine tecnolÃ³gica facilita o acesso dos atacadistas e lojistas Ã s informaÃ§Ãµes tÃ©cnicas, tabelas de preÃ§os e oportunidades reais de compra a qualquer hora do dia.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                3. NegociaÃ§Ã£o Direta e TransparÃªncia (Asset-Light)
              </h3>
              <p>
                Baseada no modelo <i>Asset-Light</i>, a plataforma funciona como um canal inteligente de intermediaÃ§Ã£o. A Global SC nÃ£o interfere nos preÃ§os, nÃ£o retÃ©m margens ocultas e nÃ£o processa pagamentos. O lojista visualiza o produto na nossa vitrine e inicia o contato para fechar o pedido diretamente com a indÃºstria ou atravÃ©s da nossa mesa de suporte comercial oficial, garantindo o melhor preÃ§o direto da fÃ¡brica, sem intermediÃ¡rios financeiros.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                4. Fortalecimento de Marca e ExpansÃ£o
              </h3>
              <p>
                Com o tempo, as marcas parceiras expandem sua presenÃ§a geogrÃ¡fica de forma escalÃ¡vel dentro do ecossistema, consolidando sua participaÃ§Ã£o no mercado fÃ­sico e digital, enquanto os lojistas encontram um ambiente blindado, rastreÃ¡vel e pautado nas melhores prÃ¡ticas de conformidade corporativa.
              </p>
...
// ============================================================================
// COMPONENTES DE RODAPÃ‰ E SELOS (PadronizaÃ§Ã£o Oficial)
// ============================================================================
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[200px_240px_180px_1fr] gap-6 md:gap-8 pt-5 pb-0 items-start justify-between">
          ...
          <div className="flex flex-col items-center md:items-start space-y-5">
            <div className="flex items-center gap-3"><svg className="w-5 h-5 text-[#c79a3a]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg><span className="text-[12px] md:text-[14px] font-bold uppercase tracking-tight">TUTORIAL:</span></div>
