      ...
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          ...
          <img 
            ...
            alt="Sede Administrativa Global SC" 
            className="w-full h-[220px] md:h-[450px] object-cover block" 
          />
        </div>
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow">
          <div className="w-full max-w-[1140px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-8 items-start mb-10">
              ...
              <div className="flex flex-col space-y-3">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`w-full text-left font-bold uppercase tracking-wider text-[13px] md:text-[15px] p-4 border border-gray-300 rounded transition-all flex justify-between items-center ${
                      activeTab === tab.id ? 'bg-[#fcf8e8] border-[#9b7324] text-[#9b7324]' : 'bg-white text-black hover:bg-gray-50'
                    }`}
                  >
                    <span>{tab.label}</span>
                    <span className="text-[#9b7324]">|</span>
                  </button>
                ))}
              </div>
              ...
              <div className="border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-10 min-h-[300px] flex flex-col justify-between shadow-sm">
                ...
                <div className="mt-12 flex justify-center w-full">
                  <a 
                    ...
                    className="w-[260px] md:w-[300px] h-[60px] md:h-[65px] rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-md"
                  >
