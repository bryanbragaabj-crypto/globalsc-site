  ...
  return (
    <main className="min-h-screen w-full bg-[#eeeeee] text-black font-sans antialiased overflow-x-hidden flex justify-center">
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        {/* BANNER DA PÁGINA (Sede Comercial Oficial) */}
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          <img 
            src="/image_81ff69.png" 
            alt="Transparência Corporativa - Global SC" 
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              ⚖️ MODELO DE OPERAÇÃO E TRANSPARÊNCIA INSTITUCIONAL B2B
            </h2>
            ...
            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              ...
              <p>
                A Global SC Alto Atacado opera como um ecossistema digital B2B (Business-to-Business) focado em revolucionar a conexão comercial entre fornecedores, fabricantes, importadoras e lojistas em todo o território nacional. Nossa infraestrutura atua como um catálogo digital inteligente, facilitando rodadas de negócios e a expansão de redes atacadistas de forma segura e escalável.
              </p>
              ...
              <p>
                Para garantir agilidade, inovação e a melhor oferta de negociação aos lojistas parceiros, nossa corporação atua baseada na metodologia <strong>Asset-Light</strong> (operações com ativos reduzidos). Isso significa que a Global SC Alto Atacado funciona como uma interface de intermediação e vitrine tecnológica: não mantemos estoque próprio de mercadorias. Todo o catálogo exibido na plataforma reflete os produtos de fornecedores rigorosamente homologados que integram a nossa rede.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                Segurança e Homologação de Fornecedores
              </h3>
              <p>
                O tráfego de informações comerciais e a exibição de produtos em nossa vitrine são regidos por diretrizes rígidas de qualidade. Cada fornecedor ou importadora listada na plataforma passa por um processo de validação, garantindo que o lojista comprador tenha acesso direto a parceiros comerciais com capacidade comprovada de entrega e idoneidade no mercado.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                Compromisso com a Transparência Legal
              </h3>
              <p>
                Em total alinhamento com o <strong>Decreto Federal nº 7.962/2013 (Lei do E-commerce)</strong> e com a Lei Geral de Proteção de Dados (LGPD), a Global SC Alto Atacado disponibiliza publicamente as informações de sua matriz gestora, estabelecendo canais diretos de comunicação para suporte aos usuários, lojistas e indústrias associadas. Nosso objetivo é fomentar um ambiente de atacado digital blindado, rastreável e pautado nas melhores práticas de compliance corporativo.
              </p>
...
// ============================================================================
// COMPONENTES DE RODAPÉ E SELOS (Padronização Oficial Exata)
// ============================================================================
      ...
      <div className="w-full max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[8px] text-gray-500 uppercase mt-1.5 tracking-[0.10em] leading-tight break-words">FRETE NA REGIÃO DE FLORIANÓPOLIS.<br/>OUTRA REGIÃO CONSULTAR VALOR</p>
          </div>
        </div>
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
        ...
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[8px] text-gray-500 uppercase mt-1.5 tracking-[0.10em] leading-tight break-words">SITE 100% CONFIÁVEL E APROVADO<br/>NO TRUSTPILOT</p>
          </div>
        </div>
      </div>
    </section>
