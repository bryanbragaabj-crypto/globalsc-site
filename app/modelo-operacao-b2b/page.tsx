...
export default function ModeloOperacaoB2B() {
  return (
    <main className="min-h-screen w-full bg-[#eeeeee] text-black font-sans antialiased overflow-x-hidden flex justify-center">
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        {/* BANNER DA PÃGINA (Sede Comercial Oficial) */}
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          <img 
            src="/image_81ff69.png" 
            alt="TransparÃªncia Corporativa - Global SC" 
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              âš–ï¸ MODELO DE OPERAÃ‡ÃƒO E TRANSPARÃŠNCIA INSTITUCIONAL B2B
            </h2>

            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              
              <p className="font-semibold text-black text-[13px] md:text-[15px]">
                Sobre a Plataforma
              </p>
              <p>
                A Global SC Alto Atacado opera como um ecossistema digital B2B (Business-to-Business) focado em revolucionar a conexÃ£o comercial entre fornecedores, fabricantes, importadoras e lojistas em todo o territÃ³rio nacional. Nossa infraestrutura atua como um catÃ¡logo digital inteligente, facilitando rodadas de negÃ³cios e a expansÃ£o de redes atacadistas de forma segura e escalÃ¡vel.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                Modelo de NegÃ³cios (Asset-Light)
              </h3>
              <p>
                Para garantir agilidade, inovaÃ§Ã£o e a melhor oferta de negociaÃ§Ã£o aos lojistas parceiros, nossa corporaÃ§Ã£o atua baseada na metodologia <strong>Asset-Light</strong> (operaÃ§Ãµes com ativos reduzidos). Isso significa que a Global SC Alto Atacado funciona como uma interface de intermediaÃ§Ã£o e vitrine tecnolÃ³gica: nÃ£o mantemos estoque prÃ³prio de mercadorias. Todo o catÃ¡logo exibido na plataforma reflete os produtos de fornecedores rigorosamente homologados que integram a nossa rede.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                SeguranÃ§a e HomologaÃ§Ã£o de Fornecedores
              </h3>
              <p>
                O trÃ¡fego de informaÃ§Ãµes comerciais e a exibiÃ§Ã£o de produtos em nossa vitrine sÃ£o regidos por diretrizes rÃ­gidas de qualidade. Cada fornecedor ou importadora listada na plataforma passa por um processo de validaÃ§Ã£o, garantindo que o lojista comprador tenha acesso direto a parceiros comerciais com capacidade comprovada de entrega e idoneidade no mercado.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                Compromisso com a TransparÃªncia Legal
              </h3>
              <p>
                Em total alinhamento com o <strong>Decreto Federal nÂº 7.962/2013 (Lei do E-commerce)</strong> e com a Lei Geral de ProteÃ§Ã£o de Dados (LGPD), a Global SC Alto Atacado disponibiliza publicamente as informaÃ§Ãµes de sua matriz gestora, estabelecendo canais diretos de comunicaÃ§Ã£o para suporte aos usuÃ¡rios, lojistas e indÃºstrias associadas. Nosso objetivo Ã© fomentar um ambiente de atacado digital blindado, rastreÃ¡vel e pautado nas melhores prÃ¡ticas de compliance corporativo.
              </p>
...
// ============================================================================
// COMPONENTES DE RODAPÃ‰ E SELOS (PadronizaÃ§Ã£o Oficial Exata)
// ============================================================================
    ...
    <section className="w-full bg-[#eeeeee] border-t-[3px] border-[#9b7324] py-10 px-4 md:px-8">
      <div className="w-full max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
          <svg viewBox="0 0 80 50" className="w-[44px] h-[30px] text-[#c89413] shrink-0" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            <path d="M5 16h26" /><path d="M1 23h26" /><path d="M8 30h20" /><path d="M34 14h20v20H34z" /><path d="M54 22h10l7 8v4H54z" /><circle cx="43" cy="38" r="4" /><circle cx="66" cy="38" r="4" />
          </svg>
          <div>
            <h4 className="text-[14px] font-black uppercase tracking-[0.20em] leading-none text-black">FRETE A COMBINAR:</h4>
            <p className="text-[8px] text-gray-500 uppercase mt-1.5 tracking-[0.10em] leading-tight break-words">FRETE NA REGIÃƒO DE FLORIANÃ“POLIS.<br/>OUTRA REGIÃƒO CONSULTAR VALOR</p>
          </div>
        </div>
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
          <svg viewBox="0 0 60 60" className="w-[40px] h-[40px] text-[#c89413] shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="30" cy="22" r="12" /><path d="M18 23v-4a12 12 0 0 1 24 0v4" /><path d="M17 25h-4v10h6" /><path d="M43 25h4v10h-6" /><path d="M42 35c0 6-5 9-12 9" /><path d="M24 44h12" /><path d="M16 56c2-8 8-12 14-12s12 4 14 12" />
          </svg>
          <div>
            <h4 className="text-[14px] font-black uppercase tracking-[0.20em] leading-none text-black">ATENDIMENTO:</h4>
            <p className="text-[8px] text-gray-500 uppercase mt-1.5 tracking-[0.10em] leading-tight break-words">DE SEGUNDA A SEXTA DAS 7H - 20H</p>
          </div>
        </div>
        <div className="h-[80px] bg-white border border-[#d8a51d] rounded-[14px] flex items-center justify-start gap-4 px-6 shadow-sm">
          <svg viewBox="0 0 60 60" className="w-[40px] h-[40px] text-[#c89413] shrink-0" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M30 5l20 8v14c0 14-9 23-20 28C19 50 10 41 10 27V13z" /><path d="M20 30l7 7 14-17" />
          </svg>
          <div>
            <h4 className="text-[14px] font-black uppercase tracking-[0.20em] leading-none text-black">SITE SEGURO:</h4>
            <p className="text-[8px] text-gray-500 uppercase mt-1.5 tracking-[0.10em] leading-tight break-words">SITE 100% CONFIÃVEL E APROVADO<br/>NO TRUSTPILOT</p>
          </div>
        </div>
      </div>
    </section>
