      ...
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex flex-col items-center">
          ...
          <div className="w-full max-w-[1000px] border border-gray-400 rounded-[30px] bg-[#f0f0f0] p-8 md:p-12 shadow-sm mb-12">
            ...
            {/* GRID DE LINKS (A Pergunta 3 está destacada) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
              <a href="/faq" className="order-1 md:order-1 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-white hover:bg-gray-50 block">
                1) O QUE A GLOBAL SC FAZ?
              </a>
              <a href="/faq/frete" className="order-4 md:order-2 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-white hover:bg-gray-50 block">
                4) O FRETE É GRÁTIS?
              </a>
              <a href="/faq/como-comprar" className="order-2 md:order-3 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-white hover:bg-gray-50 block">
                2) COMO FAÇO PARA COMPRAR?
              </a>
              <a href="/faq/garantia" className="order-5 md:order-4 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-white hover:bg-gray-50 block">
                5) O PRODUTO TEM GARANTIA?
              </a>
              <a href="/faq/prazo-de-entrega" className="order-3 md:order-5 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-[#fcf8e8] shadow-sm block">
                3) QUAL O PRAZO DE ENTREGA?
              </a>
              <a href="/faq/contato" className="order-6 md:order-6 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-white hover:bg-gray-50 block">
          ...
          <div className="w-full max-w-[1000px] flex flex-col items-center">
            ...
            <div className="w-full border border-[#b0a9c0] rounded-[30px] bg-[#fbfbfb] p-8 md:p-12 shadow-sm text-center">
              <div className="text-[13px] md:text-[15px] text-gray-800 leading-relaxed font-medium">
                <p>O prazo de entrega pode variar de acordo com o fabricante ou importador parceiro, o tipo de produto e a localidade de envio. Como a Global SC atua conectando Fabricantes e Importadores a Atacadistas dentro de um ecossistema digital de negócios, cada parceiro define suas próprias condições de envio, logística e prazos de entrega.</p>
                <p className="mt-4">Recomendamos consultar diretamente com o fornecedor ou com nossa equipe para obter informações mais precisas sobre disponibilidade, prazo de envio e entrega dos produtos.</p>
              </div>
            </div>
          </div>
