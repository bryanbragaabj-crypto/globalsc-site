...
export default function FAQGarantia() {
  return (
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex flex-col items-center">
          ...
          <div className="w-full max-w-[1000px] border border-gray-400 rounded-[30px] bg-[#f0f0f0] p-8 md:p-12 shadow-sm mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
              ...
              <a
                href="/faq/garantia"
                className="order-5 md:order-4 w-full py-4 px-6 text-center font-bold uppercase tracking-wider text-[11px] md:text-[13px] border border-black rounded-[8px] transition-all bg-[#fcf8e8] shadow-sm block"
              >
