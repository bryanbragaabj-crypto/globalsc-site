    ...
    <main className="min-h-screen w-full bg-[#eeeeee] text-black font-sans antialiased overflow-x-hidden flex justify-center">
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          {/* Certifique-se de que a extensÃ£o aqui corresponda ao arquivo que vocÃª salvou (.png ou .jpg) */}
          <img 
            src="/banner-privacidade.png" 
            alt="PolÃ­tica de Privacidade - Global SC" 
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              ðŸ“Œ PolÃ­tica de Privacidade (LGPD)
            </h2>

            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              
              <p>
                A <strong>GLOBAL SC Atacado</strong> respeita a privacidade de seus usuÃ¡rios e estÃ¡ comprometida com a proteÃ§Ã£o dos dados pessoais em conformidade com a Lei Geral de ProteÃ§Ã£o de Dados (Lei nÂº 13.709/2018 - LGPD).
              </p>
              <p>
                Esta PolÃ­tica de Privacidade tem como objetivo informar de forma transparente como coletamos, utilizamos, armazenamos e protegemos os seus dados, bem como quais sÃ£o os seus direitos sobre eles.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                1. Coleta de InformaÃ§Ãµes
              </h3>
              <p>Podemos coletar informaÃ§Ãµes fornecidas diretamente por vocÃª no ato do contato ou cadastro, tais como:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Nome completo;</li>
                <li>Telefone / WhatsApp;</li>
                <li>E-mail;</li>
                <li>CNPJ ou CPF;</li>
                <li>Dados empresariais (quando aplicÃ¡vel).</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Realizar atendimento e suporte ao usuÃ¡rio;</li>
                <li>Facilitar a conexÃ£o comercial entre Lojistas e Fornecedores parceiros;</li>
                <li>Processar solicitaÃ§Ãµes e orÃ§amentos na plataforma;</li>
                <li>Melhorar a experiÃªncia de navegaÃ§Ã£o e utilizaÃ§Ã£o do site;</li>
                <li>Enviar informaÃ§Ãµes institucionais e comerciais, quando autorizado pelo usuÃ¡rio;</li>
              ...
              <p>
                A GLOBAL SC preserva a seguranÃ§a e sigilo de seus dados. As informaÃ§Ãµes poderÃ£o ser compartilhadas <strong>apenas quando necessÃ¡rio</strong> para:
              </p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Encaminhamento de solicitaÃ§Ãµes comerciais aos fabricantes/importadoras parceiros para fins de faturamento e logÃ­stica;</li>
                <li>Prestadores de serviÃ§os essenciais para o funcionamento da plataforma (provedores de hospedagem, etc.);</li>
                <li>Cumprimento de obrigaÃ§Ãµes legais ou requisiÃ§Ãµes de autoridades competentes.</li>
              </ul>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                4. SeguranÃ§a das InformaÃ§Ãµes
              </h3>
              <p>
                Adotamos medidas tÃ©cnicas e administrativas adequadas para proteger os dados pessoais contra acessos nÃ£o autorizados, perdas, alteraÃ§Ãµes, divulgaÃ§Ãµes indevidas ou qualquer forma de tratamento inadequado.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                5. Direitos do Titular dos Dados
              </h3>
              <p>Nos termos da LGPD (Lei nÂº 13.709/2018), o usuÃ¡rio possui o direito de:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Confirmar a existÃªncia de tratamento de seus dados;</li>
                <li>Solicitar acesso, correÃ§Ã£o ou atualizaÃ§Ã£o de seus dados;</li>
                <li>Solicitar a exclusÃ£o de dados quando permitido pela legislaÃ§Ã£o;</li>
              ...
              <p>
                Nosso site utiliza cookies e tecnologias semelhantes para melhorar a navegaÃ§Ã£o, personalizar a experiÃªncia e extrair dados estatÃ­sticos sobre a utilizaÃ§Ã£o da plataforma. O usuÃ¡rio pode configurar seu navegador para bloquear cookies, ciente de que isso pode impactar algumas funcionalidades.
              </p>
              ...
              <p>
                Os dados sÃ£o armazenados apenas pelo tempo necessÃ¡rio para cumprir as finalidades descritas nesta PolÃ­tica, atender obrigaÃ§Ãµes legais, resguardar direitos da plataforma e observar os prazos previstos em lei.
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                8. AlteraÃ§Ãµes desta PolÃ­tica
              </h3>
              <p>
                Esta PolÃ­tica de Privacidade poderÃ¡ ser atualizada periodicamente para refletir melhorias em nossos serviÃ§os, adequaÃ§Ãµes normativas ou mudanÃ§as regulatÃ³rias.
              </p>
              ...
              <p>
                Em caso de dÃºvidas sobre esta PolÃ­tica de Privacidade ou sobre o tratamento de dados pessoais, entre em contato atravÃ©s dos nossos canais oficiais institucionais:<br/>
                <strong>E-mail:</strong> contato@globalscaltoatacado.com<br/>
                <strong>WhatsApp:</strong> (48) 99207-0377
              </p>

              <h3 className="font-bold text-black uppercase mt-8 border-l-[3px] border-[#9b7324] pl-3">
                10. DisposiÃ§Ãµes Finais
              </h3>
              <p>
                A utilizaÃ§Ã£o da plataforma implica na ciÃªncia e concordÃ¢ncia com esta PolÃ­tica de Privacidade.
              </p>
            </div>
...
// ============================================================================
// COMPONENTES DE RODAPÃ‰ E SELOS (Mantendo a padronizaÃ§Ã£o exata)
// ============================================================================
