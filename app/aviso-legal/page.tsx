      ...
      <div className="w-full max-w-[1260px] bg-[#eeeeee] flex flex-col shadow-xl min-h-screen">
        ...
        <nav className="w-full bg-[#eeeeee] py-4 px-4">
          <div className="flex flex-wrap justify-center items-center gap-x-10 md:gap-x-14 gap-y-2 text-[10px] md:text-[12px] font-medium underline underline-offset-4 decoration-black">
            <a href="/quem-somos" className="hover:text-[#9f7524] transition-colors">
              Quem Somos
            </a>

            <a href="/como-funciona" className="hover:text-[#9f7524] transition-colors">
              Como Funciona
            </a>
        ...
        <div className="w-full bg-black border-b-[4px] border-[#a97820]">
          <img
            src="/banner-aviso-legal.png"
            alt="Aviso Legal - Global SC"
        ...
        <section className="w-full bg-white py-12 px-4 md:px-12 flex-grow flex justify-center">
          <div className="w-full max-w-[1000px] border border-gray-300 rounded-[20px] bg-[#fbfbfb] p-6 md:p-12 shadow-sm">
            ...
            <h2 className="text-[16px] md:text-[20px] font-black uppercase tracking-wide text-black border-b-2 border-gray-200 pb-4 mb-8">
              📌 AVISO LEGAL – GLOBAL SC
            </h2>

            <div className="text-[12px] md:text-[14px] text-gray-800 leading-relaxed text-justify space-y-6">
              
              <p className="font-bold uppercase text-[13px] md:text-[15px]">
                PROPRIEDADE INTELECTUAL, LIMITAÇÃO DE RESPONSABILIDADE E COMUNICAÇÕES OFICIAIS
              </p>

              <p>
                O presente Aviso Legal estabelece as condições gerais aplicáveis à utilização da plataforma
                GLOBAL SC ATACADO, bem como define as diretrizes relativas à propriedade intelectual,
                responsabilidade civil, canais oficiais e utilização de informações institucionais no ambiente digital.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 1 – DA PROPRIEDADE INTELECTUAL
              </h3>

              <p>
                <strong>1.1. Integralidade:</strong> Toda a concepção estrutural da plataforma, incluindo
                textos, layout, identidade visual, logotipos, elementos gráficos, arquitetura de navegação,
                engenharia de informações, bancos de dados, conteúdos em vídeo exclusivos e demais ativos
                digitais pertencem à GLOBAL SC, atendendo aos seus respectivos titulares autorizados.
                <br />
                Tais elementos são protegidos pela legislação brasileira de propriedade intelectual,
                atendendo à Lei nº 9.279/1996 e à Lei nº 9.610/1998.
              </p>

              <p>
                <strong>1.2. Proteção:</strong> É terminantemente proibida a cópia, raspagem de dados
                (web scraping) ou reprodução não autorizada do nosso catálogo e modelo de negócio,
                sob pena das sanções cabíveis.
              </p>

              <p>
                <strong>1.3. Conteúdo de Terceiros:</strong> Imagens, marcas, logotipos, catálogos
                descritivos e demais materiais pertencem às fornecedoras parceiras que mantêm a propriedade
                de seus respectivos titulares. A GLOBAL SC atua exclusivamente como divulgadora autorizada
                dessas informações, não reivindicando qualquer direito de propriedade sobre as mercadorias
                de terceiros.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 2 – DA NATUREZA DA PLATAFORMA (ASSET-LIGHT)
              </h3>

              <p>
                <strong>2.1. Plataforma de Divulgação Comercial:</strong> A GLOBAL SC opera estritamente
                como um ecossistema digital B2B (Business-to-Business) destinado à divulgação de fornecedores,
                fabricantes, distribuidores e importadoras.
                <br />

                <strong>2.2. Ausência de Comercialização Direta:</strong> A plataforma funciona como um
                catálogo automatizado e vitrine tecnológica. Não mantemos estoques próprios, não emitimos
                nota fiscal de venda das mercadorias, não realizamos a venda direta e não processamos
                pagamentos financeiros (Pix, boleto ou cartão) em nosso domínio web.
                <br />

                <strong>2.3. Limitação de Responsabilidade:</strong> Todas as negociações comerciais,
                faturamentos, definições de frete e concessão de garantias ocorrem diretamente entre os
                Lojistas (compradores) e as Indústrias/Importadoras fornecedoras. A GLOBAL SC não responde
                por prejuízos logísticos, tributários ou documentais nas relações estabelecidas entre as partes.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 3 – CANAIS OFICIAIS E COMPLIANCE
              </h3>

              <p>
                <strong>3.1. Comunicações Formais:</strong> Toda e qualquer comunicação oficial de vendas,
                orçamentos, solicitações e suporte deverá ser realizada única e exclusivamente pelos canais
                destacados no rodapé desta plataforma. A Global SC não se responsabiliza por contatos
                realizados fora dos números de WhatsApp e e-mails corporativos institucionais aqui listados.
              </p>

              <h3 className="font-bold text-black uppercase mt-6 border-l-[3px] border-[#9b7324] pl-3">
                CLÁUSULA 4 – LEGISLAÇÃO APLICÁVEL E FORO
              </h3>

              <p>
                Para dirimir qualquer controvérsia decorrente do uso da plataforma, fica eleito o Foro da
                Comarca de Florianópolis, Estado de Santa Catarina, renunciando a qualquer outro, por mais
                privilegiado que seja. A plataforma aplica e interpreta as leis da República Federativa do Brasil.
              </p>
            </div>
  ...
  return (
    <footer className="w-full bg-black text-white border-t-[4px] border-[#9b7324] overflow-hidden pt-6 mt-auto">
      ...
      <div className="bg-[#c79a3a] text-black text-[9px] md:text-[10px] font-bold text-center uppercase leading-relaxed px-4 py-4 tracking-[0.08em] border-t-2 border-black relative z-20 shadow-md">
        ESTE CATÁLOGO B2B DESTINA-SE EXCLUSIVAMENTE À CONSULTA DE PRODUTOS E SOLICITAÇÃO DE
        ORÇAMENTOS. NÃO SÃO REALIZADOS PAGAMENTOS PELO SITE VIA PIX, BOLETO OU CARTÃO.
        TODAS AS NEGOCIAÇÕES, DESCONTOS E FORMAS DE PAGAMENTO DEVEM SER TRATADAS DIRETAMENTE
        COM A EMPRESA FORNECEDORA OU ATRAVÉS DO FINANCEIRO: (48) 99207-0377 – TIAGO BRAGA.
      </div>
      ...
      <div className="text-center text-[10px] md:text-[11px] text-zinc-500 py-6 space-y-1.5 bg-[#080808] tracking-widest uppercase relative z-20 font-light">
        ...
        <p>
          GLOBAL SC FÁBRICA E IMPORTADORA ALTO ATACADO | CNPJ: 59.987.080/0001-63
        </p>

        <p>
          Sede Administrativa: Av. Marginal Oeste, 90 - Monte Alegre, Camboriú - SC, 88340-000
        </p>

        <p>Contato Institucional: contato@globalscaltoatacado.com</p>

        <p className="text-zinc-600 text-[9px]">
          Plataforma B2B de Intermediação Comercial – Modelo de Catálogo Digital Automatizado
          (Asset-Light).
        </p>
      </div>
    </footer>
